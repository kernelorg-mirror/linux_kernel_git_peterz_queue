...
__visible __noendbr void fred_entry_from_user(struct pt_regs *regs);
__visible __noendbr void fred_entry_from_kernel(struct pt_regs *regs);
__visible __noendbr void __fred_entry_from_kvm(struct pt_regs *regs);
