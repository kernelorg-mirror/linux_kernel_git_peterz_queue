 ...
 * of adding a load.
 *
 * Additionally, due to running out of space, this sequence cannot use the
 * regular UD2 instruction and instead reverts to using 0xEA.
 */
asm(	".pushsection .rodata			\n"
